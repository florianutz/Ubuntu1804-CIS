...
exports.createEventType = void 0;
...
const createEventType = async (event) => {
    var _a, _b, _c, _d;
    try {
        ...
        const eventType = Object.assign(Object.assign({}, reqBody), { user_id: user.user_id, created_at: new Date(), updated_at: new Date(), event_type_id: (0, uuid_1.v4)() });
