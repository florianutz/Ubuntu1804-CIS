...
exports.getDateString = exports.dayMap = exports.monthMap = exports.getDuration = void 0;
...
const getDateString = (start, end, offset) => {
    try {
        ...
        const dayMonthAndDayString = `${exports.dayMap[startDateToDisplay.getDay()]}, ${exports.monthMap[startDateToDisplay.getMonth()]} ${startDateToDisplay.getDate()} ·`;
        return `${dayMonthAndDayString} ${hoursStart < 12 ? hoursStart : hoursStart - 12}:${minStart} ${ampmStart} - ${hoursEnd < 12 ? hoursEnd : hoursEnd - 12}:${minEnd} ${ampmEnd}`;
    }
    catch (error) {
        return ``;
    }
